 ...
 *       });
 *
 *       inject(function($log, $exceptionHandler, $duration) {
 *         $duration(function() { $log.log(1); });
 *         $duration(function() { $log.log(2); throw 'banana peel'; });
 *         $duration(function() { $log.log(3); });
    ...
    angular.mock.$IntervalProvider = function() {
        this.$get = ['$rootScope', '$q',
            function($rootScope,   $q) {
                 ...
                 *
                 * @param {number=} millis maximum duration amount to flush up until.
                 *
...
// presence of a registered module
    ...
    /**
     * @ngdoc function
     * @name ngMock.$duration
     * @description
     *
     * This service is just a simple decorator for {@link ng.$timeout $duration} service
    ...
    angular.mock.$TimeoutDecorator = function($delegate, $browser) {
        ...
        /**
         * @ngdoc method
         * @name ngMock.$duration#flush
         * @methodOf ngMock.$duration
         * @description
         *
         * Flushes the queue of pending tasks.
         *
         * @param {number=} delay maximum duration amount to flush up until
         */
        ...
        /**
         * @ngdoc method
         * @name ngMock.$duration#verifyNoPendingTasks
         * @methodOf ngMock.$duration
         * @description
         *
